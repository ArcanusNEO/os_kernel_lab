 ...
 *                set up io_base to point to the buffer you want to transfer to,
 * and set io_len to the length of buffer; initialize io_offset as desired;
 *                initialize io_resid to the total amount of data that can be
 * transferred through this io.
 */
...
/* iobuf_move - move data  (iob->io_base ---> data OR  data --> iob->io.base) in
 * memory
